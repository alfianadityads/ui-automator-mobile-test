...
public class LoginPageSteps extends BaseTest {
  ...
  @Then("user see Login failed pop up text")
  public void userSeeLoginFailedPopUpText() {
    String titleText = loginPage.loginFailedText();
    Assertions.assertEquals("Login failed", titleText);
  }
}
